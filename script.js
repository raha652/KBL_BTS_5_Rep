const SHEET_URL = "https://script.google.com/macros/s/AKfycbzJZNKeXaRvtEmPmI4z_B3RF8ryIex5WTK6IWIBnQFwszbYkUshxbBbamYOyGO64l07Lw/exec";
...
const AVAILABLE_BASES = Array.from({ length: 23 }, (_, index) => `BTS_${index + 1}`);
